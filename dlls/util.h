...
// CrazyRussian
typedef enum { point_hull=0, human_hull=1, large_hull=2, head_hull=3 } hulltype_e; // Make compiler happy
// CrazyRussian
...
extern void			UTIL_BloodDecalTrace( TraceResult *pTrace);
...
extern void		UTIL_BubbleTrail(Vector vecSrc, Vector vecEnd, BOOL Splash);
...
#define	SF_NOT_RESPAWNABLE	8//newer respawn this

// func_pushable (it's also func_breakable, so don't collide with those flags)
#define SF_PUSH_BREAKABLE	128//we  can break this object
...
char SURFACETYPE_Trace(TraceResult *ptr,  Vector vecSrc, Vector vecEnd);// XDM
...
inline BOOL StringToVec(const char *str, Vector &vec)
{
	float x,y,z;\
