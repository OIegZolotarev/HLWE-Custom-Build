...
void CEnvGlobal::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CMultiSource::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{ 
	int i = 0;
...
// ButtonShot
//
int CBaseButton::RealTakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType )
{
...
void DoSpark(entvars_t *pev, const Vector &location )
{
	...
	WRITE_COORD( tmp.y );
	WRITE_COORD( tmp.z );
	WRITE_BYTE( EXPLOSION_SPARKSHOWER_SND );
	MESSAGE_END();
}
...
void CMomentaryRotButton::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CButtonTarget::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
int CButtonTarget::RealTakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType )
{
