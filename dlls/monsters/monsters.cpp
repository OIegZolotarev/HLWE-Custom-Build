...
{
	if ( flDist > 64 && flDist <= 8192 && flDot >= 0.5 )
	{
		return TRUE;
	}
	return FALSE;
...
{
	if ( flDist > 64 && flDist <= 4096 && flDot >= 0.5 )
	{
		return TRUE;
	}
	return FALSE;
...
#define CLASS_PROJECTILE	7
	...
	static int iEnemy[8][8] =
	{	 	//NONE	MACHINE	PLAYER	HUMAN 	DEAD	INSECT	MONSTER	PROJECTILE
	/*NONE*/	{ R_NO,	R_NO,	R_NO,	R_NO,	R_NO,	R_NO,	R_NO,	R_NO},
	/*MACHINE*/	{ R_NO,	R_NO,	R_AL,	R_AL,	R_DL,	R_NO,	R_DL,	R_NO},
	/*PLAYER*/	{ R_NO,	R_AL,	R_AL,	R_AL,	R_NM,	R_NO,	R_HT,	R_NO},
	/*HUMAN*/	{ R_NO,	R_AL,	R_AL,	R_AL,	R_NM,	R_NO,	R_HT,	R_FR},
	/*DEAD*/	{ R_NO,	R_DL,	R_NM,	R_HT,	R_NO,	R_NO,	R_DL,	R_NO},
	/*INSECT*/	{ R_NO,	R_DL,	R_FR,	R_FR,	R_FR,	R_NO,	R_FR,	R_FR},
	/*MONSTER*/	{ R_NO,	R_DL,	R_HT,	R_NM,	R_DL,	R_NO,	R_NO,	R_FR},
	/*PROJECTILE*/	{ R_NO,	R_NO,	R_NO,	R_NO,	R_DL,	R_NO,	R_DL,	R_NO}
	};
